    ...
    return(
      <ShopInfoManager>
        ...
        <Tabs defaultActiveKey='1' className='content-inner'>
          <TabPane tab='详情管理' key='1'><ShopDetails shopDetails={this.props.shopDetail} cancelImg={(payload)=>{this.cancelImg(payload)}} updateCategory={(payload,record)=>{this.updateCategory(payload,record)}}/>
          </TabPane>
